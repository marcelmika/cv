...
\usepackage[hmargin=1.25cm, vmargin=1.5cm, footskip=0.2cm]{geometry} % Document margins
...
\definecolor{shade}{HTML}{644B64} % Peach color for the contact information box
\definecolor{text1}{HTML}{2b2b2b} % Main document font color, off-black
\definecolor{headings}{HTML}{673359} % Dark red color for headings
...
\scshape\Large\raggedright}{}{0em}{}[\color{black}{\titlerule[0.5pt]}]
...
\raisebox{0pt}{\textborn} & 01/11/1988 \\ % Date of birth
...
\vspace{122pt} % Trick for alignment
